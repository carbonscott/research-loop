...
The outer loop also writes significant findings to the campaign **notebook** — dead-ends, decisions, and milestones that future sessions can query. This is how knowledge persists across sessions.
